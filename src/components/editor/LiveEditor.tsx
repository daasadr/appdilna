    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="fixed top-0 left-0 right-0 bg-white border-b shadow-sm z-50">
        <div className="container mx-auto px-4 py-2 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <button
              ...
              className={`p-2 rounded ${
                viewMode === 'desktop' ? 'bg-indigo-100 text-indigo-600' : 'text-gray-600'
              }`}
            >
            ...
            <button
              ...
              className={`p-2 rounded ${
                viewMode === 'mobile' ? 'bg-indigo-100 text-indigo-600' : 'text-gray-600'
              }`}
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center space-x-4">
            <button
              className={`px-4 py-2 bg-indigo-600 text-white rounded-lg transition-all ${
                isPublishing 
      ...
      <div className="pt-16 pb-8">
        ...
        >
          {sections.map((section) => (
            <div
              key={section.id}
              className="relative group mb-8 hover:outline hover:outline-2 hover:outline-indigo-200 rounded-lg"
            >
